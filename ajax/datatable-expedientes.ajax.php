		...
		$datosJson = '{
		  	"data": [';
		  		...
		  		for ($i=0; $i < count($expedientes); $i++) {
                    ...
                    $ver = "<a class='btn btn-success btnVerExpedientes' data-toggle='tooltip' data-placement='top' title='Ver expediente' idExpediente='".$expedientes[$i]["id_paciente"]."' href='#' style='margin-right:1rem; border-radius:4px;'><i class='fa fa-address-book'></i></a>";

                    $modificar = "<a class='btn btn-warning btnModificarExpedienes' data-toggle='tooltip' data-placement='top' title='Modificar expediente' idExpediente='".$expedientes[$i]["id_paciente"]."' href='#' style='border-radius:4px;'><i class='fa fa-pencil'></i></a>";				
