		...
		$datosJson = '{
		  	"data": [';
		  		...
		  		for ($i=0; $i < count($consultas); $i++) {
					...
					$agregarConsulta = "<a class='btn btn-success btnAgregarConsulta' data-toggle='tooltip' data-placement='top' title='Agregar consulta' idConsulta='".$consultas[$i]["id_consulta"]."' style='border-radius:4px;'><i class='fa fa-stethoscope'></i></a>";	

					// Dibujar boton Ver consulta
					$verConsulta = "<a class='btn btn-info btnVerConsulta' data-toggle='tooltip' data-placement='top' title='Ver consulta' idConsulta='".$consultas[$i]["id_consulta"]."' style='border-radius:4px;'><i class='fa fa-binoculars'></i></a>";
